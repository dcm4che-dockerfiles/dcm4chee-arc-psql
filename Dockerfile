FROM dcm4che/wildfly:16.0.0-6.0.0

ENV DCM4CHEE_ARC_VERSION 5.16.2
...
ENV LDAP_URL=ldap://ldap:389 \
    ...
    WILDFLY_JMS_QUEUE_EXPORT6_CONSUMER_COUNT=1 \
    WILDFLY_JMS_QUEUE_EXPORT7_CONSUMER_COUNT=1 \
    WILDFLY_JMS_QUEUE_EXPORT8_CONSUMER_COUNT=1 \
    WILDFLY_JMS_QUEUE_EXPORT9_CONSUMER_COUNT=1 \
    WILDFLY_JMS_QUEUE_EXPORT10_CONSUMER_COUNT=1 \
    WILDFLY_JMS_QUEUE_RETRIEVE1_CONSUMER_COUNT=1 \
    WILDFLY_JMS_QUEUE_RETRIEVE2_CONSUMER_COUNT=1 \
    WILDFLY_JMS_QUEUE_RETRIEVE3_CONSUMER_COUNT=1 \
    WILDFLY_JMS_QUEUE_RETRIEVE4_CONSUMER_COUNT=1 \
    WILDFLY_JMS_QUEUE_RETRIEVE5_CONSUMER_COUNT=1 \
    WILDFLY_JMS_QUEUE_RETRIEVE6_CONSUMER_COUNT=1 \
    WILDFLY_JMS_QUEUE_RETRIEVE7_CONSUMER_COUNT=1 \
    WILDFLY_JMS_QUEUE_RETRIEVE8_CONSUMER_COUNT=1 \
    WILDFLY_JMS_QUEUE_RETRIEVE9_CONSUMER_COUNT=1 \
    WILDFLY_JMS_QUEUE_RETRIEVE10_CONSUMER_COUNT=1 \
    WILDFLY_JMS_QUEUE_RETRIEVE11_CONSUMER_COUNT=1 \
    WILDFLY_JMS_QUEUE_RETRIEVE12_CONSUMER_COUNT=1 \
    WILDFLY_JMS_QUEUE_RETRIEVE13_CONSUMER_COUNT=1
