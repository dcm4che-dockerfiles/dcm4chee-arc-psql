FROM dcm4che/wildfly:ffmpeg-30.0.1

ENV DCM4CHEE_ARC_VERSION 5.31.3
...
RUN cd $JBOSS_HOME \
    ...
    && curl -f https://www.dcm4che.org/maven2/org/dcm4che/jdbc-jboss-modules-psql/42.6.0/jdbc-jboss-modules-psql-42.6.0.tar.gz | tar xz \
