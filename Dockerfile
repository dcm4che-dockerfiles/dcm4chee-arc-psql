FROM dcm4che/wildfly:12.0.0-4.0.0

ENV DCM4CHEE_ARC_VERSION 5.14.0
...
RUN cd $JBOSS_HOME \
    ...
    && curl -f http://maven.dcm4che.org/org/dcm4che/jclouds-jboss-modules/2.1.0-noguava/jclouds-jboss-modules-2.1.0-noguava.tar.gz | tar xz \
...
ENV LDAP_HOST=ldap \
    ...
    WILDFLY_JMS_QUEUE_STGCMTTASKS_CONSUMER_COUNT=1 \
