FROM dcm4che/wildfly:38.0.1

ENV DCM4CHEE_ARC_VERSION=5.34.2
...
RUN set -eux \
    ...
    && curl -f https://www.dcm4che.org/maven2/org/dcm4che/jclouds-jboss-modules/2.7.0/jclouds-jboss-modules-2.7.0.tar.gz | tar xz \
