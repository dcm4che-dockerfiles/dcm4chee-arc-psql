...
ENV DCM4CHEE_ARC_VERSION 5.10.4
...
RUN cd $JBOSS_HOME \
    ...
    && curl -O http://www.dcm4che.org/maven2/org/dcm4che/dcm4chee-arc/dcm4chee-arr-proxy/${DCM4CHEE_ARC_VERSION}/dcm4chee-arr-proxy-${DCM4CHEE_ARC_VERSION}-secure.war
