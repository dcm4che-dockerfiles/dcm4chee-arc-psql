...
RUN cd $JBOSS_HOME \
    ...
    && curl -f https://www.dcm4che.org/maven2/org/dcm4che/querydsl-jboss-modules/4.1.4-noguava/querydsl-jboss-modules-4.1.4-noguava.tar.gz | tar xz \
    && curl -f https://www.dcm4che.org/maven2/org/dcm4che/jclouds-jboss-modules/2.0.2-noguava/jclouds-jboss-modules-2.0.2-noguava.tar.gz | tar xz \
    ...
    && curl -f https://www.dcm4che.org/maven2/org/dcm4che/jdbc-jboss-modules/1.0.0/jdbc-jboss-modules-1.0.0-psql.tar.gz | tar xz \
    ...
    && curl -fO https://www.dcm4che.org/maven2/org/dcm4che/dcm4chee-arc/dcm4chee-arc-ear/${DCM4CHEE_ARC_VERSION}/dcm4chee-arc-ear-${DCM4CHEE_ARC_VERSION}-psql-secure-ui.ear
