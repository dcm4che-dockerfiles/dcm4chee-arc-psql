...
- a not secured version (Tag Name: `5.10.2`),
- a version with secured UI and secured RESTful services (Tag Name: `5.10.2-secure`),
- a version with secured UI, but not secured RESTful services (Tag Name: `5.10.2-secure-ui`),
- a not secured version with pre-configured [GELF Logger](http://logging.paluch.biz/examples/wildfly.html)
  to emit System logs to Logstash (Tag Name: `5.10.2-logstash`),
- a version with pre-configured [GELF Logger](http://logging.paluch.biz/examples/wildfly.html) and with secured UI
  and secured RESTful services (Tag Name: `5.10.2-logstash-secure`) and
- a version with pre-configured [GELF Logger](http://logging.paluch.biz/examples/wildfly.html) and with secured UI,
  but not secured RESTful services (Tag Name: `5.10.2-logstash-secure-ui`).
