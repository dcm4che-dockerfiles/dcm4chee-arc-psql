...
- [`5.32.1` (*5.32.1/Dockerfile*)](https://github.com/dcm4che-dockerfiles/dcm4chee-arc-psql/blob/5.32.1/Dockerfile)
- [`5.32.1-secure` (*5.32.1-secure/Dockerfile*)](https://github.com/dcm4che-dockerfiles/dcm4chee-arc-psql/blob/5.32.1-secure/Dockerfile)
- [`5.32.1-secure-ui` (*5.32.1-secure-ui/Dockerfile*)](https://github.com/dcm4che-dockerfiles/dcm4chee-arc-psql/blob/5.32.1-secure-ui/Dockerfile)
...
```
```console
$ docker build -t dcm4chee-arc-psql-with-weasis-pacs-connector:5.32.1 .
