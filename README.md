...
- [`5.22.3` (*5.22.3/Dockerfile*)](https://github.com/dcm4che-dockerfiles/dcm4chee-arc-psql/blob/5.22.3/Dockerfile)
- [`5.22.3-secure` (*5.22.3-secure/Dockerfile*)](https://github.com/dcm4che-dockerfiles/dcm4chee-arc-psql/blob/5.22.3-secure/Dockerfile)
- [`5.22.3-secure-ui` (*5.22.3-secure-ui/Dockerfile*)](https://github.com/dcm4che-dockerfiles/dcm4chee-arc-psql/blob/5.22.3-secure-ui/Dockerfile)
...
```console
$ cat Dockerfile
FROM dcm4che/dcm4chee-arc-psql:5.22.3
COPY weasis-pacs-connector.war /docker-entrypoint.d/deployments
```
```console
$ docker build -t dcm4chee-arc-psql-with-weasis-pacs-connector:5.22.3 .
Sending build context to Docker daemon  1.924MB
Step 1/2 : FROM dcm4che/dcm4chee-arc-psql:5.22.3
5.22.3: Pulling from dcm4che/dcm4chee-arc-psql
...
Status: Downloaded newer image for dcm4che/dcm4chee-arc-psql:5.22.3
 ---> c84231dce4d2
Step 2/2 : COPY weasis-pacs-connector.war /docker-entrypoint.d/deployments
 ---> b0f94489c0cb
Successfully built b0f94489c0cb
Successfully tagged dcm4chee-arc-psql-with-weasis-pacs-connector:5.22.3
```
