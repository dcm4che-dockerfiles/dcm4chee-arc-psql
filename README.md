...
- [`5.13.1` (*5.13.1/Dockerfile*)](https://github.com/dcm4che-dockerfiles/dcm4chee-arc-psql/blob/5.13.1/Dockerfile)
- [`5.13.1-secure` (*5.13.1-secure/Dockerfile*)](https://github.com/dcm4che-dockerfiles/dcm4chee-arc-psql/blob/5.13.1-secure/Dockerfile)
- [`5.13.1-secure-ui` (*5.13.1-secure-ui/Dockerfile*)](https://github.com/dcm4che-dockerfiles/dcm4chee-arc-psql/blob/5.13.1-secure-ui/Dockerfile)
- [`5.13.1-logstash` (*5.13.1-logstash/Dockerfile*)](https://github.com/dcm4che-dockerfiles/dcm4chee-arc-psql/blob/5.13.1-logstash/Dockerfile)
- [`5.13.1-logstash-secure` (*5.13.1-logstash-secure/Dockerfile*)](https://github.com/dcm4che-dockerfiles/dcm4chee-arc-psql/blob/5.13.1-logstash-secure/Dockerfile)
- [`5.13.1-logstash-secure-ui` (*5.13.1-logstash-secure-ui/Dockerfile*)](https://github.com/dcm4che-dockerfiles/dcm4chee-arc-psql/blob/5.13.1-logstash-secure-ui/Dockerfile)
